 ...
 */
interface Job extends JobTemplate {
  bulletPoints: string[];
}
 ...
 */
interface JobDB extends JobTemplate {
  bulletPoints: string;
}
 ...
 */
type JobData = Omit<JobDB, "saved" | "applied" | "hidden" | "notes">;

/**
 * @description The status of a job listing, used to filter jobs in the UI.
 */
type JobStatus = "unmarked" | "saved" | "applied" | "hidden";
 ...
 */
type RefreshStatus = "init" | "fetching" | "inserting" | "completed";
